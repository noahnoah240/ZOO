...
cursor.execute("INSERT OR IGNORE INTO DIEREN (naam, beschrijving, categorie) VALUES ('Armoertijger', 'De amoertijger, ook wel Siberische tijger genoemd, is een van de grootste tijgersoorten en komt voor in de bossen van het Russische Verre Oosten. Ze hebben een dikke vacht om zich te beschermen tegen de koude winters.', 'Katachtigen')")
...
cursor.execute("INSERT OR IGNORE INTO DIEREN (naam, beschrijving, categorie) VALUES ('Armoerluipaard', 'Het amoerluipaard, ook wel Siberische luipaard genoemd, is een zeldzame en bedreigde katachtige die voorkomt in de bossen van het Russische Verre Oosten. Ze hebben een dikke vacht en zijn uitstekend aangepast aan koude klimaten.', 'Katachtigen')")
...
cursor.execute("INSERT OR IGNORE INTO DIEREN (naam, beschrijving, categorie) VALUES ('Rode_panda', 'De rode panda is een kleine zoogdier die voorkomt in de bergachtige gebieden van Nepal, India, Bhutan en China. Ze hebben een roodbruine vacht en een lange, pluizige staart.', 'Kleine_Roofdieren')")
...
cursor.execute("INSERT OR IGNORE INTO DIEREN (naam, beschrijving, categorie) VALUES ('Californische_zeeleeuw', 'De Californische zeeleeuw is een zeezoogdier dat voorkomt langs de westkust van Noord-Amerika. Ze staan bekend om hun speelse gedrag en worden vaak gezien in dierentuinen en aquaria.', 'Zeedieren')")
cursor.execute("INSERT OR IGNORE INTO DIEREN (naam, beschrijving, categorie) VALUES ('Gewone_zeehond', 'De gewone zeehond is een zeezoogdier dat voorkomt in de kustwateren van Europa, Noord-Amerika en delen van Azië. Ze hebben een grijze vacht en staan bekend om hun vermogen om zowel op het land als in het water te leven.', 'Zeedieren')")
...
cursor.execute("INSERT OR IGNORE INTO DIEREN (naam, beschrijving, categorie) VALUES ('Kaapse_buffel', 'De Kaapse buffel is een grote hoefdier die voorkomt in de savannes van Afrika. Ze staan bekend om hun kracht en agressieve gedrag, en worden vaak beschouwd als een van de gevaarlijkste dieren in Afrika.', 'Hoefdieren')")
...
cursor.execute("INSERT OR IGNORE INTO DIEREN (naam, beschrijving, categorie) VALUES ('Afrikaanse_vogelsoorten', 'Afrika herbergt een enorme diversiteit aan vogelsoorten, waaronder kleurrijke papegaaien, majestueuze arenden en sierlijke flamingos. Deze vogels spelen een belangrijke rol in de ecosystemen van Afrika.', 'Vogels')")
...
cursor.execute("INSERT OR IGNORE INTO DIEREN (naam, beschrijving, categorie) VALUES ('Tropische_rifvissen', 'Tropische rifvissen zijn een diverse groep vissen die voorkomen in de warme, ondiepe wateren van tropische koraalriffen over de hele wereld. Ze staan bekend om hun felle kleuren en unieke patronen.', 'Aquariumdieren')")
